...
import os
os.chdir('C:/Users/USER/Desktop/Projects/Image Classification/server')
...
def classify_image(image_base64_data, file_path=None):
    ...
    for img in imgs:
        ...
        # Ensure wavelet-transformed image has 1 channel
        if len(img_har.shape) == 3 and img_har.shape[2] > 1:
            img_har = img_har[:, :, 0]
